...
- (Class)rootViewClass
{
    return [CDTShapeViewController class];
}
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    Class class = [self rootViewClass];
...
{
    UIColorTansformer *transform = [[UIColorTansformer alloc] init];
    [UIColorTansformer setValueTransformer:transform forName:NSStringFromClass([transform class])];
}
...
#ifdef kSetNSUndoManager
        NSUndoManager *undoMgr = [[NSUndoManager alloc] init];
//        [undoMgr setLevelsOfUndo:10];
...
#ifdef kSetNSUndoManagerDisable
//        [_managedObjectContext.undoManager disableUndoRegistration];
        
        if ( ![_managedObjectContext.undoManager isUndoRegistrationEnabled] ) {
            [_managedObjectContext.undoManager enableUndoRegistration];
        }
#endif
#endif
    }
